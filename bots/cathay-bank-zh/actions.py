"""This is an example of Rasa action.py"""
...
#        countries = [
#            'Japan', 'Taiwan', 'Burma', 'Cambodia', 'China/HK/Macao',
#            'South Korea', 'Laos', 'Malaysia', 'Singapore',
#            'Thailand', 'The Philippines', 'Vietnam', 'Other Countries'
#        ]
#
